...
class AddCustomerKYCAttr implements DataPatchInterface, PatchRevertableInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customAdditionalCustomerAttributes = [
            'path_image_ktp' => 'KTP Image Path',
            'path_selfie_ktp' => 'KTP Selfie Path',
            'is_agree' => 'Agreement'
        ];
        $position = 1124;
        
        foreach ($customAdditionalCustomerAttributes as $attrCode => $attrLabel) {
            if ($attrCode <> "is_agree") {
