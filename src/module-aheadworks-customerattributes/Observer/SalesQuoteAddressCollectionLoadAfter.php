...
/**
 * Class SalesQuoteAddressCollectionLoadAfter
 * @package Aheadworks\CustomerAttributes\Observer
 */
class SalesQuoteAddressCollectionLoadAfter implements ObserverInterface
{
    /**
    ...
    {
        $addresses = $observer->getEvent()->getQuoteAddressCollection();
