...
/**
 * Class SalesOrderAddressCollectionLoadAfter
 * @package Aheadworks\CustomerAttributes\Observer
 */
class SalesOrderAddressCollectionLoadAfter implements ObserverInterface
{
    /**
    ...
    {
        $addresses = $observer->getEvent()->getOrderAddressCollection();
