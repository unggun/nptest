...
use Aheadworks\CustomerAttributes\Observer\SalesQuoteAddressCollectionLoadAfter;
...
/**
 * Class SalesQuoteAddressCollectionAfterLoadTest
...
class SalesQuoteAddressCollectionAfterLoadTest extends TestCase
{
    ...
    /**
     * @var SalesQuoteAddressCollectionLoadAfter
     */
    private $observer;
    ...
    public function setUp(): void
    {
        ...
        $this->observer = $objectManager->getObject(
            SalesQuoteAddressCollectionLoadAfter::class,
            [
    ...
    public function testExecute()
    {
        ...
        $eventMock->expects($this->once())
            ->method('__call')
            ->with('getQuoteAddressCollection')
