...
namespace Icube\GlobalMessage\Controller\Adminhtml\Index;
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($customerId) {
                    ...
                    $query = "UPDATE `" . $table . "` SET `telephone`= '$phoneNumber', `whatsapp_number`= '$whatsappNumber' WHERE `entity_id` = $customerId AND `store_id` = " . $customer->getStoreId();
